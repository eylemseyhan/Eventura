...
namespace EventsProject.Areas.Admin.Controllers
{
    ...
    {
        private readonly BusinessLayer.Abstract.IMessageService _messageService; // IMessageService inject ediyoruz
        ...
        public MessagesController(BusinessLayer.Abstract.IMessageService messageService, ILogger<MessagesController> logger)
        {
